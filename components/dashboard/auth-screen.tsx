      ...
      >
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full h-14 pl-11 pr-4 rounded-xl bg-[#0A0A0A] border border-[#D4AF37]/30 text-[#F5F5F5] placeholder:text-[#666666] focus:outline-none focus:border-[#D4AF37]/60 focus:ring-1 focus:ring-[#D4AF37]/20 transition-all"
            style={{ fontSize: "16px" }}
          />
        </div>
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full h-14 pl-11 pr-12 rounded-xl bg-[#0A0A0A] border border-[#D4AF37]/30 text-[#F5F5F5] placeholder:text-[#666666] focus:outline-none focus:border-[#D4AF37]/60 focus:ring-1 focus:ring-[#D4AF37]/20 transition-all"
            style={{ fontSize: "16px" }}
          />
          <button
            type="button"
          ...
          >
            {showPassword ? (
              <EyeOff className="h-5 w-5 text-[#666666]" strokeWidth={1.5} />
            ) : (
              <Eye className="h-5 w-5 text-[#666666]" strokeWidth={1.5} />
            )}
          </button>
        </div>
      ...
      >
        ...
        >
          <svg className="w-5 h-5" viewBox="0 0 24 24">
            ...
            <path fill="#D4AF37" opacity="0.8" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" />
            <path fill="#D4AF37" opacity="0.6" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z" />
            <path fill="#D4AF37" opacity="0.9" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" />
          </svg>
        </button>
