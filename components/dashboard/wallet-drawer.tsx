...
const PACKS = [
  { id: "essentiel", name: "Essentiel", tokens: 5, price: 5 },
  { id: "privilege", name: "Privil\u00e8ge", tokens: 10, price: 10 },
  { id: "prestige", name: "Prestige", tokens: 15, price: 15 },
] as const
            ...
            <div className="flex-1 overflow-y-auto overscroll-contain px-5 pb-10">
              ...
              <div className="space-y-3 mb-6">
                {PACKS.map((pack) => {
                  ...
                  const isPrestige = pack.id === "prestige"
                  return (
                    <button
                      key={pack.id}
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2">
                          ...
                          {isPrestige && (
                            <span className="px-1.5 py-0.5 text-[7px] font-bold uppercase tracking-wider rounded bg-[#D4AF37]/15 text-[#D4AF37] border border-[#D4AF37]/30">
                              Populaire
                            </span>
                          )}
                        </div>
                        <p className="text-xs text-[#A1A1AA] mt-0.5">{pack.tokens} jetons</p>
                      </div>
