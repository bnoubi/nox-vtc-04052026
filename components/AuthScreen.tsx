    ...
    >
      ...
      <div className="relative w-full max-w-sm px-6">
        ...
        >
          ...
          <span className="text-[11px] text-[#555555] tracking-wide uppercase">Ou continuer avec</span>
          <div className="flex-1 h-px bg-[#D4AF37]/20" />
        </motion.div>
        ...
        >
          ...
          <button
            ...
            className="w-14 h-14 rounded-full border border-[#D4AF37]/30 bg-[#0A0A0A] flex items-center justify-center hover:border-[#D4AF37]/60 hover:bg-[#D4AF37]/5 active:scale-95 transition-all"
          >
        ...
        >
          <button className="text-[12px] text-[#666666] hover:text-[#D4AF37]/80 transition-colors py-2 px-4">
            Mot de passe oublié ?
          </button>
          <button className="text-[12px] text-[#D4AF37]/70 hover:text-[#D4AF37] transition-colors py-2 px-4">
            Devenir Membre
          </button>
        </motion.div>
      </div>
