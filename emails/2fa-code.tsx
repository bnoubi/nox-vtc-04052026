...
export function twoFactorCodeEmail({ prenom, code }: TwoFactorCodeProps): { subject: string; html: string } {
  const firstName = prenom.trim() || 'cher utilisateur'
  const subject = 'Votre code de vérification NoX VTC'
          ...
          <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="max-width:560px;background:#1A1A1A;border:1px solid #333;border-radius:16px;padding:32px;">
            ...
            <tr>
              <td align="center" style="padding-bottom:20px;">
                <div style="display:inline-block;background:#1A1A2A;border:1px solid #C9A84C55;border-radius:12px;padding:16px 40px;text-align:center;">
                  <div style="font-size:12px;color:#8B6914;margin-bottom:8px;letter-spacing:0.08em;text-transform:uppercase;font-weight:600;">Code de vérification</div>
            ...
            <tr>
              <td style="color:#F5F5F5;font-size:15px;line-height:1.7;padding-bottom:16px;">
                ...
                <p style="margin:0 0 14px;">Votre code de vérification NoX VTC est affiché ci-dessus. Entrez-le dans l'application pour confirmer votre identité.</p>
              </td>
            </tr>
            <tr>
              <td style="padding-bottom:20px;">
                <div style="padding:12px 16px;background:#2A1A1A;border-left:3px solid #EF4444;border-radius:0 8px 8px 0;font-size:13px;color:#D4D4D8;line-height:1.6;">
                  Si vous n'avez pas demandé ce code, ignorez cet email ou contactez-nous à <a href="mailto:support@noxvtc.fr" style="color:#C9A84C;text-decoration:none;">support@noxvtc.fr</a>
                </div>
              </td>
            </tr>
            <tr>
